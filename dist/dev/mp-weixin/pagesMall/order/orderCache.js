...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const loadData = async () => {
      loading.value = true;
      const { data } = await common_vendor.index.$u.http.get("/wx/queryOrderByList", {
        data: {
          ...params,
          itemStatus: props.status !== -1 ? props.status : ""
        }
      });
      if (data.data) {
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-53dc2405"], ["__file", "C:/Users/jsyh/Documents/HBuilderProjects/suyingkechuangrong/src/pagesMall/order/orderCache.vue"]]);
