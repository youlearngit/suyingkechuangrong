  ...
  <view>
    <view class="mycollection">
      <view class="cart_box">
        ...
        <nodata :colors="colors" :loading="loading" :show="list.length===0" :count="list.length" title="足迹"></nodata>
      </view>
    </view>
  </view>
</template>
...
const {list, loading} = usePageData<Wechat.GoodsHistory>("/wx/getMyHistory",params)
